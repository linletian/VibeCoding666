...
- Improved light mode readability for top controls and product title text in both horizontal and vertical layouts
- Aligned control button/title text color with key text color in light appearance for consistent contrast

### Fixed

- Fixed poor visibility of minimize/config/close buttons and product title text when system appearance is light
...
[0.3.4]: https://github.com/yourusername/vibecoding666/compare/v0.3.3...v0.3.4
